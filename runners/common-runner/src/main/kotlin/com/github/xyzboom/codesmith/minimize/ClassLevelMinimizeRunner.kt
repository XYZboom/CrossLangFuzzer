...
class ClassLevelMinimizeRunner(
    ...
    companion object {
        fun ProgramWithRemovedClasses.removeClass(clazz: IrClassDeclaration, nextReplacementName: () -> String) {
    ...
    class ProgramWithRemovedClasses(val prog: IrProgram) : IrProgram by prog {
        ...
        val classReplaceWith = mutableMapOf<String, IrClassDeclaration>()
    ...
    override fun minimize(
        ...
        run tryRemoveAllNormal@{
            ...
            for (c in toBeRemove) {
                result.removeClass(c, ::nextReplacementName)
            }
